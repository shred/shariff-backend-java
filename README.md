...
| `targets`   | List of services to be enabled. Available: `facebook`, `flattr`, `googleplus`, `linkedin`, `twitter`. Case sensitive. Services must be separated by comma. Default is all available services. |
